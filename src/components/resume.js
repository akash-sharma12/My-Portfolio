        ...
        <div className="right">
          <div id="first">
            ...
            <div className="edu">
              <div className="edu-name">
                <p>
                  <i class="fa-solid fa-circle-dot"></i> Bachelor of Science
                </p>
                <p className="time">2019-2022</p>
              </div>
              <p className="type">Agra University</p>
            </div>
            <div className="edu">
              <div className="edu-name">
                <p>
              ...
              <p className="type">Jawahar Navodaya Vidyalaya</p>
            </div>
            <div className="edu">
              <div className="edu-name">
                <p>
          ...
          <div id="third">
            ...
            <div className="edu">
              <div className="edu-name">
                <p>
                  <i class="fa-solid fa-circle-dot"></i> News web app
                </p>
                <p className="time">2023</p>
              </div>
            ...
            <div className="edu">
              <div className="edu-name">
                <p>
                  <i class="fa-solid fa-circle-dot"></i> Whatsapp Chat webapp with React Router
                </p>
                <p className="time">2023</p>
              </div>
